...
升级前建议备份数据库，并查看 [GitHub Release](https://github.com/DeraDream/Forwardx/releases) 或项目更新日志，确认是否包含面板、Agent 或 Android 客户端更新。
...
```bash
curl -fsSL https://raw.githubusercontent.com/DeraDream/Forwardx/main/scripts/install-panel-docker.sh | sudo env FORWARDX_TARGET_VERSION=vX.Y.Z bash -s -- upgrade
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/DeraDream/Forwardx/main/scripts/install-panel-local.sh | sudo env FORWARDX_TARGET_VERSION=vX.Y.Z bash -s -- upgrade
```
...
~~~bash
curl -fsSL https://raw.githubusercontent.com/DeraDream/Forwardx/main/scripts/migrate-agent-legacy.sh | bash
curl -fsSL https://raw.githubusercontent.com/DeraDream/Forwardx/main/scripts/migrate-agent-legacy.sh | bash -s -- --apply
~~~
...
升级前建议查看 [GitHub Release](https://github.com/DeraDream/Forwardx/releases) 或项目更新日志，确认是否包含面板、Agent 或 Android 客户端更新。
