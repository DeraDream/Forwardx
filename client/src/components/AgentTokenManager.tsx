...
export default function AgentTokenManager({
  ...
  const getAgentScriptCommand = (args: string, targetPanelUrl = commandPanelUrl) => {
    ...
    const githubScriptUrl = githubAcceleratorActive
      ? `${githubAcceleratorUrl}/https://raw.githubusercontent.com/DeraDream/Forwardx/main/scripts/install-agent.sh`
      : "https://raw.githubusercontent.com/DeraDream/Forwardx/main/scripts/install-agent.sh";
