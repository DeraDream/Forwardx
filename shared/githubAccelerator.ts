...
export const PANEL_INSTALLER_RAW_URLS: Record<PanelInstallerDeployment, string> = {
  local: "https://raw.githubusercontent.com/DeraDream/Forwardx/main/scripts/install-panel-local.sh",
  docker: "https://raw.githubusercontent.com/DeraDream/Forwardx/main/scripts/install-panel-docker.sh",
};
